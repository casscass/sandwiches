...
def test_for_vegi_sandwich
    subject "vegi sandwich"
    sandwich = Sandwich.build type: 'vegi', number_of_sandwiches: 2
    ...
    step_3 = sandwich[2]
    expect step_3, "step 3", "open vegi jar"

    step_4 = sandwich[3]
    expect step_4, "step 4", "if there is vegi in jar"
    ...
    step_7 = sandwich[6]
    expect step_7, "step 7", "stick knife in vegi jar"
...
puts SandwichTest.test_for_vegi_sandwich 
